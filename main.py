...
dp.callback_query_handler(text='Маникюр')(handlers.Category.manikur)
dp.callback_query_handler(text='Педикюр')(handlers.Category.pedikur)
dp.callback_query_handler(text='Наращивание')(handlers.Category.narast)
...
dp.message_handler(state=handlers.Admin.admins.mailing_step1)(
    handlers.Admin.mailing1)
dp.message_handler(content_types=types.ContentTypes.PHOTO, state=handlers.Admin.admins.mailing_step2)(
